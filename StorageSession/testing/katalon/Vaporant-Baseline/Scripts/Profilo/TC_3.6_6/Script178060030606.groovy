...
// TC_3.6_6 — Aggiungere indirizzo con Numero Civico non compilato (RF_GP_9) — validazione client (atteso PASSED)
WebUI.openBrowser('')
...
WebUI.delay(1)
// Tutti i campi validi tranne Numero Civico (vuoto)
...
Object valid = WebUI.executeJavaScript("return document.getElementById('numero_civico').checkValidity()", null)
