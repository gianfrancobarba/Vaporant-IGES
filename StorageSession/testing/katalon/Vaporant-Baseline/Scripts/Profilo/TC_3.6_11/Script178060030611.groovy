...
// TC_3.6_11 — Aggiungere indirizzo con Provincia oltre 2 caratteri (RF_GP_9) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
WebUI.setText(css('#provincia'), 'SAL')
...
// Oracolo da requisito (UI): Provincia oltre la lunghezza (CHAR(2)) va RIFIUTATA -> si resta sul form.
// REALE: nessun controllo -> troncamento/errore lato DB, comunque non un rifiuto pulito -> FAILED = incident (CR_02).
