...
// TC_3.6_8 — Aggiungere indirizzo con Citta di soli spazi (RF_GP_9) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
// Oracolo da requisito (UI): una Citta di soli spazi va RIFIUTATA -> si resta sul form (campi del form presenti).
// REALE: AddressControl non valida -> salva e reindirizza a Utente.jsp -> il form non c'e' piu' -> FAILED = incident (CR_02).
