...
// TC_3.6_10 — Aggiungere indirizzo con Stato di soli spazi (RF_GP_9) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
WebUI.setText(css('#stato'), '   ')
WebUI.click(css('.submit-button'))
WebUI.delay(2)
WebUI.takeScreenshot()
// Oracolo da requisito (UI): Stato di soli spazi RIFIUTATO -> si resta sul form. REALE: salvato e redirect -> FAILED = incident (CR_02).
