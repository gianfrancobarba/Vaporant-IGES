...
// TC_2.1_8 — Registrazione con Password non compilata (RF_GR_3) — validazione client (atteso PASSED)
WebUI.openBrowser('')
WebUI.navigateToUrl(GlobalVariable.base + 'SignForm.jsp')
WebUI.delay(1)
// Tutti i campi validi tranne Password (lasciata vuota)
WebUI.executeJavaScript("document.getElementById('nome').value='Mario';" +
	...
	"document.getElementById('email').value='mario.rossi@example.com';", null)
Object valid = WebUI.executeJavaScript("return document.getElementById('password').checkValidity()", null)
