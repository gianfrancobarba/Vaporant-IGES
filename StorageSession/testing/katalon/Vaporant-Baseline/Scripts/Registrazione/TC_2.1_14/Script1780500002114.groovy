...
// TC_2.1_14 — Registrazione con Email in formato non valido (RF_GR_3) — validazione client (atteso PASSED)
WebUI.openBrowser('')
WebUI.navigateToUrl(GlobalVariable.base + 'SignForm.jsp')
WebUI.delay(1)
// Tutti i campi validi; Email in formato non valido (senza @)
...
// Oracolo (UI/DOM): il campo e' type=email -> formato non valido -> il browser blocca l'invio.
