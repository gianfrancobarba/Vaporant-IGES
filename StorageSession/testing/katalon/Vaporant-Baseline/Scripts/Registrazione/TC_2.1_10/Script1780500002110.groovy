...
// TC_2.1_10 — Cognome di soli spazi (RF_GR_3) — ROBUSTEZZA (WARNING, giudizio manuale)
WebUI.openBrowser('')
...
KeywordUtil.markWarning('Cognome di soli spazi: interpretare lo screenshot (loginForm = accettato/incident, SignForm = rifiutato). Eseguire su DB con email/CF di riferimento nuovi.')
WebUI.closeBrowser()
