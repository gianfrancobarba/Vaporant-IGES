...
// TC_2.1_17 — Registrazione con Codice Fiscale di 15 caratteri (BVA CHAR(16)) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
// Oracolo da requisito (UI): CF di lunghezza != 16 RIFIUTATO -> resta su SignForm. REALE: nessun controllo -> accettato -> loginForm -> FAILED = incident (CR_02).
