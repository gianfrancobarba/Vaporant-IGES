...
// TC_2.1_3 — Registrazione con Cognome non compilato (RF_GR_3) — validazione client (atteso PASSED)
WebUI.openBrowser('')
WebUI.navigateToUrl(GlobalVariable.base + 'SignForm.jsp')
WebUI.delay(1)
// Tutti i campi validi tranne Cognome (lasciato vuoto)
...
Object valid = WebUI.executeJavaScript("return document.getElementById('cognome').checkValidity()", null)
