...
// TC_2.1_10 — Registrazione con Cognome di soli spazi (RF_GR_3) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
// Oracolo da requisito (UI): Cognome di soli spazi RIFIUTATO -> resta su SignForm. REALE: accettato -> loginForm -> FAILED = incident (CR_02).
