...
// TC_3.6_7 — Aggiungere indirizzo con Stato non compilato (RF_GP_9) — validazione client (atteso PASSED)
WebUI.openBrowser('')
...
WebUI.delay(1)
// Tutti i campi validi tranne Stato (vuoto)
...
Object valid = WebUI.executeJavaScript("return document.getElementById('stato').checkValidity()", null)
