...
// TC_3.6_13 — Aggiungere indirizzo con Numero Civico oltre 4 caratteri (RF_GP_9) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
WebUI.setText(css('#numero_civico'), '12345')
WebUI.setText(css('#stato'), 'Italia')
WebUI.click(css('.submit-button'))
WebUI.delay(2)
WebUI.takeScreenshot()
// Oracolo da requisito (UI): Numero Civico oltre la lunghezza (CHAR(4)) va RIFIUTATO -> si resta sul form. REALE: troncato/errore -> FAILED = incident (CR_02).
