...
// TC_3.6_4 — Aggiungere indirizzo con Cap non compilato (RF_GP_9) — validazione client (atteso PASSED)
WebUI.openBrowser('')
...
WebUI.delay(1)
// Tutti i campi validi tranne Cap (vuoto)
...
Object valid = WebUI.executeJavaScript("return document.getElementById('cap').checkValidity()", null)
WebUI.verifyEqual(valid, false)
WebUI.click(css('.submit-button'))
WebUI.delay(1)
WebUI.takeScreenshot()
WebUI.verifyElementPresent(css('#citta'), 5)
WebUI.closeBrowser()
