...
// TC_3.4_4 — Modificare password con nuova vuota (RF_GP_7) — oracolo da requisito (incident atteso)
WebUI.openBrowser('')
...
// Oracolo da requisito (UI): una nuova password vuota va RIFIUTATA -> NON deve comparire il messaggio di successo.
// REALE: ModifyControl non valida -> mostra "Password modificata con successo!" -> FAILED = incident (hardening CR_02/CR_03).
