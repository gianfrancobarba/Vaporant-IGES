...
// TC_3.6_3 — Aggiungere indirizzo con Provincia non compilata (RF_GP_9) — validazione client (atteso PASSED)
WebUI.openBrowser('')
...
WebUI.delay(1)
// Tutti i campi validi tranne Provincia (vuota)
...
Object valid = WebUI.executeJavaScript("return document.getElementById('provincia').checkValidity()", null)
