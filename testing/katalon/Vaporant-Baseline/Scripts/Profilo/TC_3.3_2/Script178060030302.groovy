...
// Oracolo da requisito (UI): telefono vuoto RIFIUTATO -> NON deve comparire il messaggio di conferma.
// REALE: ModifyControl non valida -> "Numero di cellulare modificato con successo" -> FAILED = incident (CR_02).
